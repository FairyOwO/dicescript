...
func _roll32(src RandomSource, dicePoints int) int {
...
func Roll(src RandomSource, dicePoints IntType, mod int) IntType {
	if dicePoints == 0 {
		return 0
	}
	if mod == -1 {
...
func RollWoD(src RandomSource, addLine IntType, pool IntType, points IntType, threshold IntType, isGE bool, mode int) (IntType, IntType, IntType, string) {
	var details []string
	addTimes := 1
...
func RollDoubleCross(src RandomSource, addLine IntType, pool IntType, points IntType, mode int) (IntType, IntType, IntType, string) {
	var details []string
	addTimes := 1
...
func RollCommon(src RandomSource, times, dicePoints IntType, diceMin, diceMax *IntType, isKeepLH, lowNum, highNum IntType, mode int) (IntType, string) {
	var nums []IntType
...
func RollCoC(src RandomSource, isBonus bool, diceNum IntType, mode int) (IntType, string) {
...
func RollFate(src RandomSource, mode int) (IntType, string) {
	detail := ""
	sum := IntType(0)
	for i := 0; i < 4; i++ {
		n := Roll(src, 3, mode) - 2
